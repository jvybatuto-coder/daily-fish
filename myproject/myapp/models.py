...
class Fish(models.Model):
    ...
    weight_kg = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(Decimal('0.01'))], help_text="Weight of fish in kilograms")
    total_price = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(Decimal('0.00'))], help_text="Total price for this fish")
    date_purchased = models.DateField(help_text="Date when fish was purchased to track freshness")
